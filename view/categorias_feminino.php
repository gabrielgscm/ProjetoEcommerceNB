      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <div class="dropdown">
                <a class="nav-link" href="index.php" role="button" id="dropdownMenuLink" data-toggle="dropdown"
