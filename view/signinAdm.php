		...
		<div class="row" style="margin-top: 100px">
			...
			<div class="col">
				<form class="form-signin" method="post">
					...
					<input type="email" name="emailAdministrador" id="inputUsuário" class="form-control" placeholder="Email" required autofocus>
					<label for="inputSenha" class="sr-only">Senha</label>
					<input type="password" name="senhaAdministrador" id="inputSenha" class="form-control" placeholder="Senha" required>
    ...
    if(isset($action) && $action != ""){ 
        ...
        switch($action){
            case 'logar':
                ...
                require_once('class/AutenticaAdm.class.php');
                //instancio a classse para poder usar o método nela contida
                $Autentica = new Autentica();
                //setando 
                $Autentica->emailAdministrador = $_POST['emailAdministrador'];
                $Autentica->senhaAdministrador = $_POST['senhaAdministrador'];
                //chamando o método                     
