				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							...
							<div class="card-body">
								<h4 class="card-title">
									<a href="products/vestido/signed_produto_000001.php">FiveBlu</a>
								</h4>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							...
							<div class="card-body">
								<h4 class="card-title">
									<a href="products/diversos/signed_produto_000002.php">H Heli</a>
								</h4>
								<h6><strike>R$89,90</strike> por</h6>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							...
							<div class="card-body">
								<h4 class="card-title">
									<a href="products/diversos/signed_produto_000003.php">Colcci</a>
								</h4>
