      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <div class="dropdown">
                <a class="nav-link active" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                  aria-expanded="false">
                  Categorias
                </a>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <div class="list-group">
            <a class="list-group-item list-group-item-dark" style="color: #fff;-webkit-touch-callout: none;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;"
              unselectable="on">Vestidos</a>
        ...
        <div class="col-lg-9">
          ...
          <!-- Produto -->
          <div class="card mt-4">
            <img class="card-img-top img-fluid rounded mx-auto d-block" src="../../img/vestido_1.jpg" alt="Vestido FiveBlu Curto Liso Preto"
              style="max-width: 40%;height: auto;">
            <div class="card-body">
            <?php while ($user = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
              <h3 class="card-title" style="color: #e8c264"><?php echo $user['nomeProduto']?></h3>
              <h5><strike>R$89,90</strike> por</h5>
              <h4><strong>R$<?php echo number_format($user['precoUnitarioProduto'], 2, ',', '.') ?></strong></h4>              
              <hr>
              <div class="row">
                <div class="col">
                ...
                <div class="col">
                  <a type="button" href="../../carrinho.php?acao=add&id=<?php echo $user['pk_idProduto']?>" class="btn btn-success btn-lg">Comprar</a>
