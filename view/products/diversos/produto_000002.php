...
$sql = "SELECT * FROM produto where pk_idProduto = 2 ORDER BY nomeProduto ASC;";
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<!-- Produto -->
				<div class="card mt-4">
					<img class="card-img-top img-fluid rounded mx-auto d-block" src="../../img/blusa_1.jpg" alt="Blusa Ciganinha H Heli Floral Branca/Verde" style="max-width: 40%;height: auto;">
					<div class="card-body">
						<?php while ($user = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
						<h3 class="card-title" style="color: #e8c264">
							<?php echo $user['nomeProduto']?>
						</h3>
						<h5><strike>R$59,90</strike> por</h5>
						<h4><strong>R$
						...
						<div class="row">
							<div class="col">
								<p class="card-text">Detalhes do produto: <br> <br>
									Manga: Curta <br>
									Decote: V (Cavado) <br>
									Tipo de Tecido: Plano <br>
									Cor: Branco <br>
									Material: Poliéster <br>
									Modelo: H Heli 173026</p>
