...
$sql = "SELECT * FROM produto where pk_idProduto = 3 ORDER BY nomeProduto ASC;";
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<!-- Produto -->
				<div class="card mt-4">
					<img class="card-img-top img-fluid rounded mx-auto d-block" src="../../img/calca_1.jpg" alt="Calça Jeans Colcci Skinny Cory Azul" style="max-width: 40%;height: auto;">
					<div class="card-body">
